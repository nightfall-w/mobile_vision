...
from app.llm.request_models import CreateCredentialRequest, UpdateCredentialRequest
...
def list_credentials(
    ...
    data = [credential.to_dict(hide_api_key=True) for credential in result['list']]
