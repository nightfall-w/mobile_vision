...
import fire
from funboost import BoostersManager, ctrl_c_recv
...
if __name__ == '__main__':
    ...
    BoosterDiscovery(project_root_path, booster_dirs=[os.path.join(project_root_path, 'services')], max_depth=1,
                     py_file_re_str=None).auto_discovery()  # 这个最好放到main里面,如果要扫描自身文件夹,没写正则排除文件本身,会无限懵逼死循环导入
